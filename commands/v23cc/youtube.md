---
name: v23cc:youtube
description: Summarize a YouTube video using local Gemma LLM
allowed-tools: Bash
model: haiku
---

Summarize a YouTube video using subtitles (or Whisper fallback) and the local Gemma LLM.
