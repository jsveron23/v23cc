...
export const CONFIG_PATH = path.join(os.homedir(), '.v23cc', 'config.json');
...
export const V23CC_BIN = path.join(os.homedir(), '.v23cc', 'bin');
export const V23CC_MCP = path.join(os.homedir(), '.v23cc', 'mcp');
